    ...
    public void run() throws UserExistsException {
        ...
        while (a) {
            ...
            if (menu == 0) {
                ...
                System.out.println("Number of Workers: " + banksystem.numberofusers(workercounter, false));
                System.out.println("Number of Customers: " + banksystem.numberofusers(counter, true));
            ...
            if (menu == 1) {
                ...
                menu1 = in.nextInt();
                if (menu1 == 1) {
                    System.out.println("Already registered " + banksystem.numberofusers(counter, true) + " Customer and " + banksystem.numberofusers(workercounter, false) + " Worker\n" + banksystem + "\n" + probel);
                    //System.out.println("List of workers; " + workers+probel);
                }
                if (menu1 == 2) {
